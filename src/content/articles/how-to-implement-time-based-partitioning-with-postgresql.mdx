---
title: 'How to implement time-based partitioning with PostgreSQL'
...
![Query Explanation](/articles/how-to-implement-time-based-partitioning-with-postgresql/explain-query.png)
