        ...
        <div className='md:space-y-10 space-y-8 relative z-10'>
          ...
          <div className='space-y-2 sm:text-sm text-xs'>
            ...
            <p className='text-muted-foreground'>
              ...
              <a target='_blank' href='https://github.com/leeminkan/portfolio-site' className='text-light-brown hover:underline hover:text-foreground transition-colors'>
                &apos;https://github.com/leeminkan/portfolio-site&apos;
              </a>
            </p>
          </div>
        </div>
